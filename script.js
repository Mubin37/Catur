...
function changeTurn() {
    ...
    if(moveAmount === 0) {
        ...
        if(whitesTurn && checkIfPlayerIsInChess("w", board)) {
            moveCounter.innerHTML = "skatmat, hitam menang!";

        } else if (!whitesTurn && checkIfPlayerIsInChess("b", board)) {
            moveCounter.innerHTML = "skatmat, putih menang!";
        } else {
            moveCounter.innerHTML = "Seri!";
        }

    } else {
        moveCounter.innerHTML = "langkah tersedia: " + moveAmount;
    }
}
